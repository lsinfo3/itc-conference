...
![]({{site.baseurl}}/assets/Persistent/itc32_ajla.png){:class="typo3-neos-alignment-right" style="width:500px"}
...
![]({{site.baseurl}}/assets/Persistent/itc32_rsa.png){:class="typo3-neos-alignment-right"}
...
![]({{site.baseurl}}/assets/Persistent/itc32_bpa.png){:class="typo3-neos-alignment-right"}
...
![]({{site.baseurl}}/assets/Persistent/itc32_stg.png){:class="typo3-neos-alignment-right"}
