...
In *34th International Teletraffic Congress (ITC-34)*.  Shenzhen, China 2022<br/>
[\[BibTeX\]](javascript:toggleVis('itcpaper1'))
[\[Abstract\]](javascript:toggleVis('abstract_1'))
[\[Download\]](https://thomasez.folk.ntnu.no/itc34/papers/1.pdf)
[\[BibSonomy\]]()
...
Shutao Zhang, Xinzhi Ning, Xi Zheng, Qingjiang Shi, Tsung-Hui Chang, Zhi-Quan Luo <br/>
**A Physics-based and Data-driven Approach for Localized Statistical Channel Modeling**<br/>
In *34th International Teletraffic Congress (ITC-34)*.  Shenzhen, China 2022<br/>
[\[BibTeX\]](javascript:toggleVis('itcpaper7'))
[\[Abstract\]](javascript:toggleVis('abstract_7'))
[\[Download\]](https://thomasez.folk.ntnu.no/itc34/papers/7.pdf)
[\[BibSonomy\]]()
...
Redha Abderrahmane Alliche, Tiago Da Silva Barros, Ramon Aparicio-Pardo, Lucile Sassatelli <br/>
**Impact Evaluation of Control Signalling onto Distributed Learning-based Packet Routing**<br/>
In *34th International Teletraffic Congress (ITC-34)*.  Shenzhen, China 2022<br/>
[\[BibTeX\]](javascript:toggleVis('itcpaper9'))
[\[Abstract\]](javascript:toggleVis('abstract_9'))
[\[Download\]](https://thomasez.folk.ntnu.no/itc34/papers/9.pdf)
[\[BibSonomy\]]()
...
Vartika Singh, Veeraruna Kavitha <br/>
**Short Paper: Fair opportunistic schedulers for Lossy Polling systems**<br/>
In *34th International Teletraffic Congress (ITC-34)*.  Shenzhen, China 2022<br/>
[\[BibTeX\]](javascript:toggleVis('itcpaper13'))
[\[Abstract\]](javascript:toggleVis('abstract_13'))
[\[Download\]](https://thomasez.folk.ntnu.no/itc34/papers/13.pdf)
[\[BibSonomy\]]()
...
**Single Observer Geolocation for Periodic Communication Signals based on Doppler and TOA**<br/>
In *Joint Workshop of Smart Industrial Networking and Satellite Based IoT*.  Shenzhen, China 2022<br/>
[\[BibTeX\]](javascript:toggleVis('itcwspaper1'))
[\[Abstract\]](javascript:toggleVis('wsabstract_1'))
[\[Download\]](https://thomasez.folk.ntnu.no/itc34/workshop%20papers/1.pdf)
[\[BibSonomy\]]()

<div id="itcwspaper1" style="display: none;" class="bibtex">
    @inproceedings{  ,
...
<div id="wsabstract_1" style="display: none;" class="abstract">
    <strong>Abstract:</strong>    The disadvantages of single observer localization
...
of the accuracy analysis. </div>

Zhilin Liu, Yao Zhu, Yulin Hu, Peng Sun, Ning Guo, and Anke Schmeink <br/>
**Joint Time and Power Allocation for NOMA-Assisted Low-Latency Mobile Edge Computing**<br/>
In *Joint Workshop of Smart Industrial Networking and Satellite Based IoT*.  Shenzhen, China 2022<br/>
[\[BibTeX\]](javascript:toggleVis('itcwspaper2'))
[\[Abstract\]](javascript:toggleVis('wsabstract_2'))
[\[Download\]](https://thomasez.folk.ntnu.no/itc34/workshop%20papers/2.pdf)
[\[BibSonomy\]]()

<div id="itcwspaper2" style="display: none;" class="bibtex">
    @inproceedings{  ,
...
<div id="wsabstract_2" style="display: none;" class="abstract">
    <strong>Abstract:</strong>   In this paper, we study a mobile edge computing
...
reliability and low-latency. We characterize the overall service
 ...
 considered network. </div>


Bruce Mareri, Ruijie Ou, Yu Pang <br/>
** DeepSmart: A Deep Learning Strategy for Real-time B5G/6G Edge Analytics and Anomaly Detection**<br/>
In *Joint Workshop of Smart Industrial Networking and Satellite Based IoT*.  Shenzhen, China 2022<br/>
[\[BibTeX\]](javascript:toggleVis('itcwspaper2'))
[\[Abstract\]](javascript:toggleVis('wsabstract_2'))
[\[Download\]](https://thomasez.folk.ntnu.no/itc34/workshop%20papers/2.pdf)
...
<div id="itcwspaper3" style="display: none;" class="bibtex">
    @inproceedings{  ,
...
<div id="wsabstract_3" style="display: none;" class="abstract">
    <strong>Abstract:</strong>    Wireless communication has increased signifi
...
ated using real-world datasets, and the results demonstrate that
 it outperforms established classical approaches in forecasting. </div>
 
 
 Daniel Ayepah-Mensah, Guolin Sun, Yu Pang, Wei Jiang <br/>
** Adaptive Digital Twin and Communication-Efficient Federated Learning Network Slicing for 5G-enabled Internet of Things**<br/>
In *Joint Workshop of Smart Industrial Networking and Satellite Based IoT*.  Shenzhen, China 2022<br/>
[\[BibTeX\]](javascript:toggleVis('itcwspaper4'))
[\[Abstract\]](javascript:toggleVis('wsabstract_4'))
[\[Download\]](https://thomasez.folk.ntnu.no/itc34/workshop%20papers/4.pdf)
[\[BibSonomy\]]()

<div id="itcwspaper4" style="display: none;" class="bibtex">
    @inproceedings{  ,
...
<div id="wsabstract_4" style="display: none;" class="abstract">
    <strong>Abstract:</strong>    Wireless communication has increased significantly in recent years. To address future connectivity require
ments, some researchers are focused on Beyond 5G (B5G)
 and Sixth-Generation (6G) wireless technology that capitalizes
 on Internet of Things (IoT) technologies to convert sensory
 data into actionable knowledge. Intelligent factories that are
...
Gordon Owusu Boateng, Guisong Liu <br/>
**Cooperative Resource Trading for Network Slicing in Industrial IoT: A Multi-Agent DRL Approach**<br/>
In *Joint Workshop of Smart Industrial Networking and Satellite Based IoT*.  Shenzhen, China 2022<br/>
[\[BibTeX\]](javascript:toggleVis('itcwspaper5'))
[\[Abstract\]](javascript:toggleVis('wsabstract_5'))
[\[Download\]](https://thomasez.folk.ntnu.no/itc34/workshop%20papers/5.pdf)
[\[BibSonomy\]]()

<div id="itcwspaper5" style="display: none;" class="bibtex">
    @inproceedings{  ,
...
<div id="wsabstract_5" style="display: none;" class="abstract">
    <strong>Abstract:</strong>    Wireless communication has increased significantly in recent years. To address future connectivity require
ments, some researchers are focused on Beyond 5G (B5G)
 and Sixth-Generation (6G) wireless technology that capitalizes
 on Internet of Things (IoT) technologies to convert sensory
...
ated using real-world datasets, and the results demonstrate that
 ...
 Anjie Qiu, Donglin Wang, Sanket Partani and Hans D. Schotten <br/>
**Modern OpenAI Gym Simulation Platforms for Vehicular Ad-hoc Network Systems**<br/>
In *Joint Workshop of Smart Industrial Networking and Satellite Based IoT*.  Shenzhen, China 2022<br/>
[\[BibTeX\]](javascript:toggleVis('itcwspaper6'))
[\[Abstract\]](javascript:toggleVis('wsabstract_6'))
[\[Download\]](https://thomasez.folk.ntnu.no/itc34/workshop%20papers/6.pdf)
[\[BibSonomy\]]()

<div id="itcwspaper6" style="display: none;" class="bibtex">
    @inproceedings{  ,
...
<div id="wsabstract_6" style="display: none;" class="abstract">
    <strong>Abstract:</strong>  The great demands of Machine Learning (ML) are
